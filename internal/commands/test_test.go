...
// TestRunTests_JSONMode_Success — JSON mode happy path: c.Run() returns
// nil so the function returns nil and skips printCoverageTotal even
// with coverage=true (NDJSON contract).
